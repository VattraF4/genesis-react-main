...
const steps = [
    {
        id: 1,
        title: "Shipment Intake & Planning",
        description: "Submit shipment details, origin, destination, and requirements. Our system automatically optimizes routes, allocates resources, and generates pickup schedules in real-time.",
        link: "#!",
    ...
    },
    {
        ...
        description: "Monitor shipments in transit with real-time GPS tracking. Optimize routes for fuel efficiency, adjust deadlines, manage inventory, and coordinate with carriers seamlessly.",
        link: "#!",
    ...
    },
    {
        ...
        description: "Complete deliveries with digital proof of delivery. Generate automated reports, update customer status, track performance metrics, and optimize future shipments.",
        link: "#!",

    ...
    return (
        <>
            ...
            >
                ...
                <div className="absolute rounded-full top-80 right-0 -translate-x-1/2 size-130 bg-[#F26A06] blur-[100px]" />
                {/* blue */}
                <div className="absolute rounded-full top-0 left-1/2 -translate-x-1/2 size-130 bg-[#2E08CF] blur-[100px]" />
            </motion.div>

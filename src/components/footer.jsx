...
export default function Footer() {
    ...
    return (
        ...
        >
            <a href="#!">
                <img src='/assets/lokka_width-removebg.png' alt='logo' className='h-8.5 w-auto' width={205} height={48} />
            </a>
            ...
            <div className="flex flex-col md:flex-row items-center w-full justify-between gap-4 py-4">
                <p>Lokka Logistics Co., LTD.</p>
                <p>Copyright © 2026 <a href="https://lokkalogistic.com" target="_blank">All rights reserved</a></p>
            </div>
        </motion.footer>
    );
};